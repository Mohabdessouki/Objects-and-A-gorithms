...
def encrypt(S):
    ...
    if len(SC)%2==0:
        ...
        L=[]        
        for i in range(0,(len(SC)-2), 2):
            if not SC[i]==SC[i+1]:
                P=SC[i]+SC[i+1]
                L.append(P)
            elif SC[i]==SC[i+1]:
                L.append(SC[i]+"X")
        L.append(SC[len(SC)-1]+"X")     
    ...
    for i in range(len(CIPHER)):
        for j in range(len(CIPHER[i])):
            DCIPHER[(i,j)]=CIPHER[i][j]       

    for i in range(len(CIPHER)):
        for j in range(len(CIPHER[i])):
            PCIPHER[CIPHER[i][j]]=(i,j)         
    ML=[]
    for i in L:
        T=""
#Same
        if i[0]==i[1]:
            ...
            ML.append(T)
#Row
        elif PCIPHER[i[0]][0]==PCIPHER[i[1]][0]:
            if PCIPHER[i[0]][1]==4 and not PCIPHER[i[1]][1]==4:
                T=DCIPHER[(PCIPHER[i[0]][0], (PCIPHER[i[0]][1])-4)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])+1)]
                
                ML.append(T)
                
            elif (not PCIPHER[i[0]][1]==4) and PCIPHER[i[1]][1]==4:
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])+1)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])-4)]
                
                ML.append(T)            
            
            elif PCIPHER[i[0]][1]==4 and PCIPHER[i[1]][1]==4:
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])-4)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])-4)]
                
            elif (not PCIPHER[i[0]][1]==4) and (not PCIPHER[i[1]][1]==4):
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])+1)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])+1)]                
                
                ML.append(T)             
            
#Column
            
        elif PCIPHER[i[0]][1]==PCIPHER[i[1]][1]:
            if PCIPHER[i[0]][0]==4 and not PCIPHER[i[1]][0]==4:
                T=DCIPHER[(PCIPHER[i[0]][0]-4, (PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]+1, (PCIPHER[i[1]][1]))]
                
                ML.append(T)
                
            elif (not PCIPHER[i[0]][0]==4) and PCIPHER[i[1]][0]==4:
                T=DCIPHER[(PCIPHER[i[0]][0]+1,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]-4, (PCIPHER[i[1]][1]))]
                
                ML.append(T)            
            
            elif PCIPHER[i[0]][0]==4 and PCIPHER[i[1]][0]==4:
                T=DCIPHER[(PCIPHER[i[0]][0]-4,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]-4, (PCIPHER[i[1]][1]))]
                
            elif (not PCIPHER[i[0]][0]==4) and (not PCIPHER[i[1]][0]==4):
                T=DCIPHER[(PCIPHER[i[0]][0]+1,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]+1, (PCIPHER[i[1]][1]))]               
...
#Rectangle
        ...
        elif (not PCIPHER[i[0]][1]==PCIPHER[i[1]][1]) and (not PCIPHER[i[0]][0]==PCIPHER[i[1]][0]):
            
                T=DCIPHER[(PCIPHER[i[0]][0], (PCIPHER[i[1]][1]))]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[0]][1]))]
...
#Row
            ...
            if PCIPHER[i[0]][1]==0 and not PCIPHER[i[1]][1]==0:
                T=DCIPHER[(PCIPHER[i[0]][0], (PCIPHER[i[0]][1])+4)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])-1)]
                
                ML.append(T)
                
            elif (not PCIPHER[i[0]][1]==0) and PCIPHER[i[1]][1]==0:
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])-1)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])+4)]
                
                ML.append(T)            
            
            elif PCIPHER[i[0]][1]==0 and PCIPHER[i[1]][1]==0:
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])+4)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])+4)]
                
            elif (not PCIPHER[i[0]][1]==0) and (not PCIPHER[i[1]][1]==0):
                T=DCIPHER[(PCIPHER[i[0]][0],(PCIPHER[i[0]][1])-1)]+DCIPHER[(PCIPHER[i[1]][0], (PCIPHER[i[1]][1])-1)]                
...
#Column
            ...
            if PCIPHER[i[0]][0]==0 and not PCIPHER[i[1]][0]==0:
                T=DCIPHER[(PCIPHER[i[0]][0]+4, (PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]-1, (PCIPHER[i[1]][1]))]
                
                ML.append(T)
                
            elif (not PCIPHER[i[0]][0]==0) and PCIPHER[i[1]][0]==0:
                T=DCIPHER[(PCIPHER[i[0]][0]-1,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]+4, (PCIPHER[i[1]][1]))]
                
                ML.append(T)            
            
            elif PCIPHER[i[0]][0]==0 and PCIPHER[i[1]][0]==0:
                T=DCIPHER[(PCIPHER[i[0]][0]+4,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]+4, (PCIPHER[i[1]][1]))]
                
            elif (not PCIPHER[i[0]][0]==0) and (not PCIPHER[i[1]][0]==0):
                T=DCIPHER[(PCIPHER[i[0]][0]-1,(PCIPHER[i[0]][1]))]+DCIPHER[(PCIPHER[i[1]][0]-1, (PCIPHER[i[1]][1]))]               
...
print(encrypt("handicraftsman lookup getaway cowslip"))
