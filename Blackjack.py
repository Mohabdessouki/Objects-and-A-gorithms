...
def next_move(S):
    ...
    T1=(2*S.count("2"))+(3*S.count("3"))+(4*S.count("4"))+(5*S.count("5"))+(6*S.count("6"))+(7*S.count("7"))+(8*S.count("8"))+(9*S.count("9"))+(10*S.count("0"))+(10*S.count("J"))+(10*S.count("Q"))+(10*S.count("K"))
    
    if (T1+(11*S.count("A")))>=17 and (T1+(11*S.count("A")))<=21:
        return "Stay"
    elif (T1+(1*S.count("A")))>=17 and (T1+(1*S.count("A")))<=21:
        return "Stay"
    elif (T1+(11*S.count("A")))<17 or (T1+(1*S.count("A")))<17:
        return "Hit"
    elif (T1+(1*S.count("A")))>21:
        return "Bust"
