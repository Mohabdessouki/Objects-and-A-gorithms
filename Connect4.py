...
def check_winner(tt):
    ...
    for i in range(len(tt)):
        for j in range(0,(len(tt[i])-3)):
            if tt[i][j]==tt[i][j+1] and tt[i][j]==tt[i][j+2] and tt[i][j]==tt[i][j+3] and (tt[i][j]=="X" or tt[i][j]=="O"):
    ...
    for i in range(7):
        for j in range(3):
            if tt[j][i]==tt[j+1][i] and tt[j][i]==tt[j+2][i] and tt[j][i]==tt[j+3][i] and (tt[j][i]=="X" or tt[j][i]=="O"):
    ...
    for i in range(4):
        for j in range(3):
            if tt[j][i]==tt[j+1][i+1] and tt[j][i]==tt[j+2][i+2] and tt[j][i]==tt[j+3][i+3] and (tt[j][i]=="X" or tt[j][i]=="O"):
                return tt[j][i]

    for i in range(3):
        for j in range(3,7):
            if tt[i][j]==tt[i+1][j-1] and tt[i][j]==tt[i+2][j-2] and tt[i][j]==tt[i+3][j-3] and (tt[i][j]=="X" or tt[i][j]=="O"):
                return tt[i][j]
